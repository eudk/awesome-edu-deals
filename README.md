[![Awesome](https://img.shields.io/badge/Awesome-Edu%20Deals-000000.svg?logo=github&labelColor=24292e)](https://awesome.re)
[![Stars](https://img.shields.io/github/stars/eudk/awesome-edu-deals?style=social)](https://github.com/eudk/awesome-edu-deals/stargazers)
...
## Table of contents
- [0) Start here (Setup suggestions)](#0-start-here-setup-suggestions)
- [🤖 AI Tools & Student Deals](#-ai-tools--student-deals)
...
It helps to do these steps first. Many other offers require you to have the GitHub pack already active.

1. **Get verified on GitHub** - Apply here: https://github.com/education/students
2. **Claim the GitHub Student Developer Pack** - Once verified, go here: https://education.github.com/pack
3. **Organize your email** - It is helpful to make a specific folder in your inbox for "Student Perks" so you don't lose renewal emails or license keys.

[↑ Go to top](#table-of-contents)

---

## 🤖 AI Tools & Student Deals
...
| Tool | Offer | Notes |
| :--- | :--- | :--- |
| **Cursor** | 12 months free Pro | A popular code editor. Verified students can often get a year of Pro. |
| **GitHub Copilot** | Free | Included with the GitHub Student Developer Pack. |

### Other AI Tools (Writing & Media)

| Tool | Offer | Notes |
| :--- | :--- | :--- |
| **ElevenLabs** | Discounts / Credits | Often found in bundles like the AI Student Pack. |
| **Notion AI** | Discounted | Often available as an add-on to the Notion Education plan. |
| **NotebookLM** | Free features | Google often updates this tool with students in mind. |
...
This is usually considered the most important pack to get. One verification here unlocks benefits on many other sites.

**Claim here:** https://education.github.com/pack
...
## 2) Cloud credits and hosting

These services let you put your website or app on the internet.

| Provider | What is offered | Link |
| :--- | :--- | :--- |
...
If you want your own `.com` or `.me` website name.

| Provider | Offer | Link |
| :--- | :--- | :--- |
| **Namecheap** | 1 year `.me` domain + security | [Via GitHub Pack](https://nc.me/landing/github) |
...
## 6) Learning and courses

Platforms that usually cost money but have free periods for students.
...
## 9) Discount platforms

If you don't see what you need above, you can check these general discount sites. You usually need to upload a student ID.
